...
const char* ssid = "ESP32TEST";         // Enter SSID here
const char* password = "12345678";  // Enter Password here
const int GPIO_PIN19 = 19; // GPIO pin to control pushbutton 1
const int GPIO_PIN18 = 18; // GPIO pin to control pushbutton 2
